...
export default class UserSearchPage extends React.Component {
  ...
  render() {
      ...
      <Form labelAlign="left">
        <Row gutter={24}>
          <Col xs={24} sm={12} md={12} lg={8} xl={8}>
            <Item label="用户名称:">{d('username')(<Input placeholder="请输入" />)}</Item>
          </Col>

          <Col xs={24} sm={12} md={12} lg={8} xl={8}>
            <Item label="手机号码:">{d('phone')(<Input placeholder="请输入" />)}</Item>
          </Col>
      ...
      <Form labelAlign="left">
        <Row gutter={24}>
          ...
          <Col xs={24} sm={12} md={12} lg={8} xl={8}>
            <Item label="注册时间:">
              {d('created_at')(
                <DatePicker placeholder="请选择注册时间" style={{ width: '100%' }}></DatePicker>,
              )}
            </Item>
          </Col>
    ...
    return (
      <Card style={{ marginBottom: '1%' }} bodyStyle={{ paddingBottom: 0, paddingTop: '3%' }}>
